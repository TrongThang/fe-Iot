      ...
      if (res.ok) {
        ...
        const normalizedHouses = Array.isArray(dataHouse)
          ? dataHouse.map((group) => ({
              ...
              icon_name: group.icon_name?.toUpperCase() ?? "HOUSE",
              icon_color: group.icon_color ?? COLOR_MAP.BLUE,
              icon_color_id: group.icon_color_id ?? "BLUE",
              space: 0,
            }))
          : [];
                    ...
                    <div className="flex items-center space-x-6 relative z-10">
                      <div className="relative">
                        <div
                          ...
                          style={{ backgroundColor: house.icon_color }}
                        >
                          <IconComponent
