...
import AdminTicketsDashboard from "@/pages/Admin_1/ticket_manager/ticket-list-manager";
...
import AdminCustomerDashboard from "@/pages/Admin_1/customer_manager/customerList";
import UserActivity from "@/pages/User/setting/user-activity";
import DeviceSharingList from "@/pages/User/share/shareDeviceList";
import SearchCustomerGroups from "@/pages/Admin_1/search/searchCustomerGroups";
import SearchCustomerHouses from "@/pages/Admin_1/search/searchCustomerHouses";
import SearchCustomerSpaces from "@/pages/Admin_1/search/searchCustomerSpaces";
import SearchCustomerDevices from "@/pages/Admin_1/search/searchCustomerDevices";
import SearchCustomerInfo from "@/pages/Admin_1/search/searchCustomerInfo";
import DashboardAdmin from "@/pages/Admin_1/Dashboard/dashboard";
import CustomerShare from "@/pages/Admin_1/customer_manager/customerShareList";
