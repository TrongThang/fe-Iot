			...
			<Card>
				<CardContent className="p-6">
					<div className="text-center">
						<div
							className={`w-24 h-24 mx-auto mb-4 rounded-full flex items-center justify-center ${device.power_status ? "bg-amber-100" : "bg-gray-100"
								}`}
						>
		...
		<div className="space-y-6">
			...
			<Card className={isWarning ? "border-red-200 bg-red-50" : ""}>
				<CardContent className="p-6">
					<div className="text-center">
						<div
							className={`w-24 h-24 mx-auto mb-4 rounded-full flex items-center justify-center ${isWarning ? "bg-red-100" : device.power_status ? "bg-green-100" : "bg-gray-100"
								}`}
						>
							<Flame
		...
		<div className="space-y-6">
			...
			<Card>
				<CardContent className="p-6">
					<div className="text-center">
						<div
							className={`w-24 h-24 mx-auto mb-4 rounded-full flex items-center justify-center ${tempStatus === "hot" ? "bg-red-100" : tempStatus === "cold" ? "bg-blue-100" : "bg-green-100"
								}`}
						>
							<Thermometer
								className={`w-12 h-12 ${tempStatus === "hot" ? "text-red-500" : tempStatus === "cold" ? "text-blue-500" : "text-green-500"
									}`}
							/>
						</div>
